...
class zerif_ourfocus extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        <div class="col-lg-3 col-sm-3 focus-box" data-scrollreveal="enter left after 0.15s over 1s">
            ...
            <p class="focus-btn"><button class="btn btn-primary custom-button red-btn cstm">Зарезервировать</button></p>
            <p class="focus-btn"><a href="<?echo $instance['link']?>#price" class="btn btn-primary custom-button green-btn">Цены</a></p>
            <!-- FOCUS HEADING -->
